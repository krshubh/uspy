...
from .views import CallLogView, MessageLogView, \
                    CallLogChildView, MessageLogChildView
...
urlpatterns = [
    ...
    path('call_log/children/<int:id>/',CallLogChildView.as_view(), name = "call log children"),
    
    
    path('message/',MessageLogView.as_view(), name = "message"),
    path('message/children/<int:id>/',MessageLogChildView.as_view(), name = "message log children"),
]
