...
from .models import User, Profile, Address, Contact, CallLog, Message, ContactUs
...
class AddressAdminConfig(admin.ModelAdmin):
    list_display = ('address1', 'address2', 'city',
...
class ContactUsAdminConfig(admin.ModelAdmin):
    list_display = ('sender_email', 'to_email', 'subject',
                    'name', 'message', 'created_date')
